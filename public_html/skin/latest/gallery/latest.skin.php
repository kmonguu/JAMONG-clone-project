...
?>
<style>
	.swiper_m4 {width:100%; height:390px; position:relative; box-shadow:10px 10px 15px 0px rgba(0, 0, 0, 0.2); background:#fff; margin-top:30px;}
</style>

<div class="swiper-container swiper_m4">
	...
	?>
		...
		<div class="swiper-slide">
			<div style="width: 100%; height: 390px; background:#fff;" >
				...
				<div>
					<div style="width:56px; height:56px; background:#775844; float:right; margin-right:30px; color:#fff; font-size:16px; font-weight:500; text-align:center; line-height:55px;">NEW</div>
				</div>

				<div style="padding:116px 0 0 656px;">
					<div>
...
<script>
	...
	$(function(){
		swiper_gallery = new Swiper('.swiper_m4', {
						spaceBetween: 60,
						centeredSlides: true,
						autoplay: {
							delay: 4000,
