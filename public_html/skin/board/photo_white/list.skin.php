...
#GalleryUl > li { float:left; width:23.8%; margin:0 0 20px 1.6%; position:relative; }
#GalleryUl > li:nth-child(4n+1) { margin-left:0%; }
...
.GU_subj { width:100%; font-size:16px; color:#222; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; text-align:left; padding-bottom:10px; }
/*
.GU_subj {
