			...
			<input type="hidden" name="url" value='<?=$login_url?>'>
				...
				<div style="display:inline-block; text-align:center; width:100%;" >
					<div>
						...
						<p style="font-weight:400; color:#373737; font-size:30px; line-height:1.1em; padding:10px 0 10px 5px;" >회원 로그인</p>
				...
				<div style="width:478px; margin:20px auto 30px;" >
					<div style="display:inline-block; width:100%;" >
						<div style="display:inline-block; float:left; height:33px; line-height:33px; font-size:18px; color:#676767; " >
							<input type='checkbox' id='id_save' name='id_save' value="1" <?=$ch_id_save_chk?> />
							<label for="id_save">아이디 저장</label>
						</div>
						
						<div style="display:inline-block; float:right;" >
							<a href="./register.php" class="login_bot_btn" >회원가입</a>
							<span class="login_bot_bar" >|</span>
							<a href="javascript:win_password_lostM();" class="login_bot_btn" >아이디/비밀번호 찾기</a>
						</div>
					</div>
				</div>
