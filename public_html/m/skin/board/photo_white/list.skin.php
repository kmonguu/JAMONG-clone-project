...
.GU_thumb { width:100%; height:<?=$board["bo_2"]?>px; object-fit:cover; display:block; float:left; }
.GU_con { float:left; width:100%; box-sizing:border-box; padding:20px 20px; border:1px solid #ddd; }
.GU_subj { width:100%; font-size:20px; color:#222; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; text-align:left; padding-bottom:10px; }
/*
.GU_subj {
...
.GU_date { float:left; font-size:16px; color:#777; }
.GU_name { float:right; font-size:16px; color:#777; }
</style>
...
.board_search #stx {  }
.board_search #search_input > #stx { border:0; width:170px; height:34px; margin:0; padding:0 0 0 10px; letter-spacing:0px; color:#777; font-size:16px; }
.search_option_box { 
	width:120px; height:36px; border:1px solid #e5e5e5; position:relative; float:left; font-size:16px; padding:0 0 0 10px; 
	background:url("/img/search_arrow.jpg") no-repeat right 10px center; color:#777;
			...
			?>
				...
				<li>
					<a href="<?=$list[$i]["href"]?>" >
						...
						<div class="GU_con">
							<div class="GU_subj" ><?=$list[$i]["subject"]?></div>
							<div class="GU_date_name" >
								<div class="GU_date" ><?=date("Y.m.d",strtotime($list[$i][datetime]))?></div>
								<div class="GU_name" ><?=$list[$i]["name"]?></div>
							</div>
						</div>
					</a>
