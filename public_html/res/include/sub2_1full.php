<style>
	...
	.reservation_on { opacity:0; }
	.reservation_on:hover { opacity:1; }
	...
	.sub2_div4 { width:1200px; height:560px; background:url('/res/images/subvisual/sub2_3.jpg') no-repeat center top; margin:0 auto; padding-top:50px; }
...
<div class="sub2_div1">Family Twin</div>
<div class="sub2_div2">
	...
	<a href="#menulink" onclick="menulink('menu04-1')"><img class="reservation" src="/res/images/subvisual/sub2_1.jpg" alt="예약 바로 가기 버튼" /></a>
	<a href="#menulink" onclick="menulink('menu04-1')"><img class="reservation_on" src="/res/images/subvisual/sub2_2.jpg" alt="예약 바로 가기 버튼 효과" /></a>
...
<div class="sub2_div3">
	<div class="swiper-container swiper-subvisual_2" >
		 ...
		 <div class="swiper-wrapper">
			<?for($i=1; $i<=10; $i++){?>
				<div style="background:url('/res/images/subvisual/sub2/<?=$i?>.jpg'); background-position:center center;" class="swiper-slide" >
				</div>
			<?}?>
		</div>
	</div>
